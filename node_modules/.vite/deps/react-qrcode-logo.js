...
// node_modules/react-qrcode-logo/dist/esm/index.js
var QRCode = class extends import_react.default.Component {
  constructor(props) {
    super(props);
    __publicField(this, "canvasRef", import_react.default.createRef());
  }
  download(fileType, fileName) {
    if (this.canvasRef.current) {
      ...
      const url = this.canvasRef.current.toDataURL(mimeType, 1);
  ...
  update() {
    ...
    const qrCode = qrcode_default(0, ecLevel);
    qrCode.addData(this.utf16to8(value));
    qrCode.make();
    const canvas = (_a = this.canvasRef) == null ? void 0 : _a.current;
    ...
    if (qrStyle === "dots") {
      ...
      for (let row = 0; row < length; row++) {
        for (let col = 0; col < length; col++) {
          if (qrCode.isDark(row, col) && !this.isInPositioninZone(row, col, positioningZones) && !this.removeCoordinateBehindLogo(removeQrCodeBehindLogo ?? false, row, col, dWidthLogo, dHeightLogo, dxLogo, dyLogo, cellSize, offset, logoImage, logoPadding, logoPaddingStyle)) {
            ctx.beginPath();
      ...
      for (let row = 0; row < length; row++) {
        for (let col = 0; col < length; col++) {
          if (qrCode.isDark(row, col) && !this.isInPositioninZone(row, col, positioningZones) && !this.removeCoordinateBehindLogo(removeQrCodeBehindLogo ?? false, row, col, dWidthLogo, dHeightLogo, dxLogo, dyLogo, cellSize, offset, logoImage, logoPadding, logoPaddingStyle)) {
            let roundedCorners = [false, false, false, false];
  ...
  render() {
    ...
    return import_react.default.createElement("canvas", { id: this.props.id ?? "react-qrcode-logo", height: qrSize, width: qrSize, style: { height: qrSize + "px", width: qrSize + "px", ...this.props.style }, ref: this.canvasRef });
  }
};
__publicField(QRCode, "defaultProps", {
...
function deepEqual(a, b, visited = /* @__PURE__ */ new WeakMap()) {
  ...
  if (Object.getPrototypeOf(a) === Object.prototype || Object.getPrototypeOf(a) === null) {
